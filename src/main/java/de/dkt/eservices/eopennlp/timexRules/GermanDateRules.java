...
public class GermanDateRules {
	...
	public static RegexNameFinder initGermanDateFinder(){
		...
		final String maxFourDigitNumber = "[1-9][0-9]?[0-9]?[0-9]?";
		...
		germanDateRegexMap.put(11, String.format("\\b%s\\b", day));//automated
		...
		germanDateRegexMap.put(14, String.format("(?i)\\b%s %s vor (jahresende|monatsende)\\b", alphaNumber, day)); // automated
		germanDateRegexMap.put(15, String.format("\\b%s\\b", gegenwärtig));// automated
		germanDateRegexMap.put(16, String.format("\\bnächste(r|s|n)? (%s|%s|%s|%s)\\b", day, week, month, year));// automated
		germanDateRegexMap.put(17, String.format("(?i)\\bdiese(s|r|m|n)? (%s|%s|%s|%s)\\b", day, week, month, year));// automated
		...
		germanDateRegexMap.put(22, String.format("(?i)\\bnach %s (%s|%s|%s|%s)\\b", alphaNumber, day, week, month, year));//automated
		...
		germanDateRegexMap.put(29, String.format("\\b%s\\b", morgen));//automated
		...
		germanDateRegexMap.put(32, String.format("\\b(?i)(vor|seit) (%s|%s) (Jahren|Monaten|Tagen)\\b", maxFourDigitNumber, alphaNumber));//automated
		...
		Pattern[] regexes = {
			...
			Pattern.compile(germanDateRegexMap.get(32))
		};
...
System.setOut(out);
String input = "Türkisches Parlament berät über Lage -- Das türkische Parlament will heute mittag in einer Sondersitzung über die Sicherheitslage beraten. Die türkische Luftwaffe hatte gestern ihre Angriffe auf Stellungen der kurdischen PKK ausgeweitet und erstmals auch Einrichtungen auf türkischem Boden bombardiert. Zuvor hatte Ankara sich darauf beschränkt, kurdische Ziele im Nordirak zu attackieren.  Zugleich geht Ankara seit der vorigen Woche gegen die Terrormiliz Islamischer Staat in Syrien vor. Die NATO hatte der Türkei gestern ihre Solidarität im Kampf gegen den Terror versichert. ---------- USA verteidigen Erdogan -- Die US-Regierung hat die türkischen Luftangriffe auf die kurdische PKK als Akt der Selbstverteidigung eingestuft. Die PKK habe Anschläge auf türkische Polizisten verübt und sei der Aggressor, hieß es von ranghohen Regierungsbeamten in Washington.  Auch die NATO hatte gestern auf Kritik an dem türkischen Vorgehen gegen kurdische Rebellen verzichtet. Allgemein erklärte sich der NATO-Rat aber solidarisch mit dem türkischen Vorgehen gegen den Terrorismus. Die Türkei bombardiert seit voriger Woche erstmals Stellungen des Islamischen Staates in Syrien. ---------- Briten wollen Eurotunnel sichern -- Die britische Regierung will zusätzlich umgerechnet zehn Millionen Euro ausgeben, um den Eurotunnel unter dem Ärmelkanal zu sichern. Das kündigte Innenministerin May nach einem Treffen mit ihrem französischen Kollegen Cazeneuve an. In der Nacht zu gestern hatten mehr als 2.000 Flüchtlinge versucht, den Tunnels von Calais aus zu stürmen. Nach Angaben der französischen Behörden wurden 200 von ihnen festgenommen. Es sei der bisher größte Versuch gewesen, über den Tunnel nach Großbritannien zu gelangen.  Etwa 3.000 Migranten, vor allem aus Afrika, campieren seit Monaten rund um Calais. Immer wieder versuchen sie, sich in Lastwagen zu verstecken, die nach Großbritannien fahren. ---------- Börse in Athen soll bald wieder öffnen -- In Athen könnte die Börse bald wieder öffnen. Wie aus Börsenkreisen verlautete, hat die Europäische Zentralbank den Aktienhandel in Griechenland wieder erlaubt. Mit dem Start wird in den nächsten Tagen gerechnet, das griechische Finanzministerium müsse nur noch über die Bedingungen der Wiedereröffnung entscheiden. Die Börse in Athen hatte am 26. Juni geschlossen, wenige Stunden bevor Ministerpräsident Tsipras das Referendum über die Sparvorgaben der Kreditgeber ankündigte. ---------- Ex-Spion Pollard kommt frei -- Nach 30 Jahren Haft in den USA kommt der israelische Ex-Spion Jonathan Pollard im November frei. Das teilten seine Anwälte mit. Die Haftstrafe des 60-jährigen werde zur Bewährung ausgesetzt, hieß es. Zugleich widersprachen sie Spekulationen, dass die Freilassung ein politisches Zugeständnis der USA sein könnte, um Israel wegen des Atomabkommens mit dem Iran zu besänftigen. Pollard war 1985 in den USA festgenommen und verurteilt worden, weil er geheime Dokumente an Israel weitergegeben hatte. Der Fall hat die Beziehungen zwischen den USA und Israel seit jeher getrübt. Israels Regierungschef Netanjahu begrüßte die geplante Freilassung. ---------- Kabinett: Korrupte Ärzte sollen ins Gefängnis -- Die Bundesregierung will Korruption im Gesundheitswesen künftig stärker bekämpfen. Ärzten, Apothekern, Physiotherapeuten und Pflegekräften drohen demnächst bis zu drei Jahre Gefängnis, wenn sie sich der schweren Bestechung oder Bestechlichkeit schuldig machen.  Das Bundeskabinett will heute (9.30) einen entsprechenden Gesetzentwurf von Justizminister Maas beschließen.  Außerdem will die Ministerrunde einen Entwurf von Arbeitsministerin Nahles verabschieden, der jungen Asylsuchenden den Zugang zu Berufs-Praktika erleichtern soll. ---------- Gauck würdigt Maccabi-Games -- Bundespräsident Gauck hat am Abend in der Waldbühne in Berlin die jüdischen Maccabi-Sportspiele offiziell eröffnet. Er würdigte es als wichtiges historisches Symbol, dass sich ausgerechnet im Berliner Olympiastadion jüdische Sportler zu Wettkämpfen versammeln. 1936 seien genau dort jüdische Sportler von den Olympischen Spielen ausgeschlossen worden. Es sei ein großartiger Vertrauensbeweis für das Deutschland von heute, dass so viele Sportler aus Israel hierher kämen, fügte Gauck vor 10.000 Zuschauern hinzu. Die Maccabi Games sind die größte jüdische Sportveranstaltung Europas. 2.500 jüdische Sportler aus 36 Ländern werden bis zum 5. August in 19 Disziplinen gegeneinander antreten. ---------- 290347 Jul 15 _  Chinas Börsen werden noch länger unter Turbulenzen leiden. Fehlen  jetzt Zeit und Wille für nötige Reformen, verlangsamt sich Chinas  Wachstum weiter. Davon wäre auch Deutschland empfindlich getroffen.  Shanghai (dpa) - Die massive staatliche Intervention an Chinas Börsen  weckt Zweifel an der Entschlossenheit der Regierung, dringend nötige  marktwirtschaftliche Reformen umzusetzen. Nach einem Handelsauftakt  am Mittwoch im Plus lagen die Aktienmärkte in Shanghai und Shenzhen  gegen Mittag wieder leicht im Minus. Die neue Talfahrt hatte am  Montag mit dem größten Tagesverlust seit acht Jahren angefangen.  Hintergrund waren Sorgen über einen Rückzug der staatlichen  Unterstützung und schlechte Nachrichten aus der Realwirtschaft.   Experten rechnen damit, dass Chinas Aktienmärkte noch über Monate  größeren Schwankungen ausgesetzt sein werden, weil sie jetzt extrem  von staatlicher Unterstützung abhängig seien. «Schon die kleinsten  Hinweise auf einen möglichen Rückzug des Staates aus den Märkten  können zu Panikverkäufen führen», sagte die Wirtschaftsexpertin  Sandra Heep vom Berliner China-Institut Merics der Deutschen  Presse-Agentur in Peking.   Der Parteistaat habe mit seinen massiven Interventionen «eine neue  Quelle der Instabilität geschaffen», sagte Heep. Niemand wisse, wie  lange die staatliche Unterstützung anhalten oder wie die Märkte bei  einer Verringerung der Hilfe reagieren werden.   Angesichts der massiven Interventionen gebe es große Zweifel an der  Entschlossenheit der Partei, ihre 2013 abgegebenen Reformversprechen  in einem schwierigen wirtschaftlichen Umfeld umzusetzen. «Zudem  frisst das permanente Krisenmanagement der Aktienmärkte die Energie  wichtiger staatlicher Akteure, die von der dringend notwendigen  Planung struktureller Reformen abgelenkt werden», sagte Heep.   Werde die Umsetzung der Reformen, die auf Stärkung des Binnenkonsums  und der Innovationsfähigkeit chinesischer Unternehmen abzielen,  weiter verzögert, werde es «unweigerlich einen weiteren Einbruch der  Wachstumsraten zur Folge haben», sagte Heep. «Das würde auch die  deutsche Wirtschaft empfindlich treffen, die sich in eine starke  Abhängigkeit vom chinesischen Markt begeben hat.»  Seit vergangenem Monat hatten Chinas Aktienmärkte eine extreme Berg-  und Talfahrt hingelegt: Getrieben von Privatanlegern, die in großen  Stil Aktien auf Pump kauften, war der Leitindex in Shanghai binnen  eines Jahres um über 150 Prozent gestiegen. Mitte Juni begann dann  ein rasanter Kurseinbruch. Innerhalb von nur 18 Handelstagen verlor  der Index 32 Prozent an Wert. Mit radikalen Eingriffen gelang es der  Regierung, zunächst die Kurse zu stabilisieren.  # Notizblock  ## Redaktionelle Hinweise  - Zusammenfassung bis 1300, ca. 40 Zl.  * * * *  Die folgenden Informationen sind nicht zur Veröffentlichung bestimmt  ## Kontakte  - Autor: Andreas Landwehr (Peking), +086 106 5321-473, <landwehr.andreas@dpa.com>  - Redaktion: Jürgen Gesper (Berlin), +49 30 2852 31302, <politik-ausland@dpa.com>  dpa lw xx z2 gp  «290540 Jul 15  L  Kasan (dpa) - Paul Biedermann geht trotz seiner Weltjahresbestzeit  über 200 Meter Freistil ohne Medaillenziel in seine letzte  Schwimm-Weltmeisterschaften. «Ich will versuchen, das bestmögliche  Rennen zu schwimmen und dann hoffentlich zufrieden sein mit dem, was  ich geleistet habe», sagte der Weltrekordler in einem dpa-Interview.  Dass seine Zeit von 1:45,60 Minuten immer noch von keinem  Konkurrenten in diesem Jahr unterboten wurde, ist für Biedermann nur  «Standortbestimmung für den Moment».  2016 soll Olympia in Rio der Schlusspunkt der Karriere sein. Die  berufliche Zukunft des 28-Jährigen scheint inzwischen Konturen  gewonnen zu haben - und das im heimischen Halle/Saale.   «Momentan hab ich Angebote, im Sport zu bleiben, eine  Funktionärsstelle, auch wenn ich das Wort nicht so gerne höre. Etwas  wo ich dem Sport in Halle und Umgebung mit eigenen Ideen unter die  Arme greifen kann und versuchen kann, die Bedingungen noch zu  verbessern», sagte der Doppel-Weltmeister von 2009. «Die  Möglichkeiten im Sport zu bleiben sind schon da. Das freut mich. Es  ist eine Entlastung zu wissen, man steht danach nicht vor dem  Nichts.»  Ein Jahr vor Olympia in Rio sieht Biedermann das deutsche Schwimmen  insgesamt wieder auf einem guten Weg. «Wir haben auch im Nachwuchs  einige Talente, die noch etwas Zeit brauchen. Ich denke wir sind  vorangekommen. Letztendlich kann man das erst nach den Olympischen  Spielen beurteilen», erklärte der Staffel-Europameister von Berlin.  # Notizblock  ## Redaktionelle Hinweise  - Zusammenfassung als Biedermann-Story bis 1330 - ca. 45 Zl  - Interview Biedermann bis 1100 - ca. 75 Zl  ## Internet  - [WM-Zeitplan](http: dpaq.de/b6DvB)  - [WM-Schauplätze in Kasan](http: dpaq.de/3Z5hf)  - [Deutsche Weltmeister seit 1973](http: dpaq.de/iNbm9)  - [Deutsches WM-Team/pdf-Broschüre](http: dpaq.de/PaHUO)  - [News auf WM-Homepage](http: dpaq.de/4K1IB)  - [Zahlen zur WM-Historie](http: dpaq.de/SjjoI)  - [WM-Resultate](http: dpaq.de/4OebS)  - [Live-Timing](http: dpaq.de/K9x2n)  - [WM-Preisgeld](http: dpaq.de/cpshl)  ## Orte  - [Becken- und Synchronschwimmen](prospekt Khusaina Yamasheva, 115,    Kazan, Respublika Tatarstan, Russland, 420133)  - [Wasserspringen](Kazan Aquatics Palace, ulitsa Sibgata Khakima, 70,    Kazan, Respublika Tatarstan, Russland, 421001)  - [Freiwasserschwimmen und Klippenspringen](reka Kazanka, Kazan,    Respublika Tatarstan, Russland, 420099)  - [Wasserball-Arena](Kazan Aquatics Palace, ulitsa Sibgata Khakima,    70, Kazan, Respublika Tatarstan, Russland, 421001)  * * * *  Die folgenden Informationen sind nicht zur Veröffentlichung bestimmt  ## Kontakte  - Autor: Marc Zeilhofer (Kasan), <zeilhofer.marc@dpa.com> und Christian Kunz (Kasan) <kunz.christian@dpa.com>  - Redaktion: Jens Marx (Berlin), +49 30 285232232, <sport@dpa.com>  - Foto: Newsdesk, + 49 30 2852 31515, <foto@dpa.com>  dpa ze kun yyzz n1 jmx  «290540 Jul 15  L";      
...
LinkedList<String> normalizedStartAndEnd = normalizeGermanDate(input.substring(s.getStart(), s.getEnd()));;
			...
			if (Pattern.matches(String.format("^%s$", p), foundDate)){
				...
				if (key == 32){
					...
					if(parts[1].matches("[1-9][0-9]?[0-9]?[0-9]?")){
						...
						number = convertGermanAlphaNumber(parts[1]);	
					}
