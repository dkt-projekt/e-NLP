...
public class TestConstants {
	...
	static String expectedResponse11 = "@prefix dktnif: <http://dkt.dfki.de/ontologies/nif#> .\n"
			...
			+"@prefix time:  <http://www.w3.org/2006/time#> .\n"
			+"\n"
			+"<http://dkt.dfki.de/documents/#char=0,47>\n"
			+"        a                     nif:RFC5147String , nif:String , nif:Context ;\n"
			+"        dktnif:meanDateEnd    \"2016-12-17T16:07:45\"^^xsd:dateTime ;\n"
			+"        dktnif:meanDateStart  \"2016-12-17T16:07:45\"^^xsd:dateTime ;\n"
			+"        nif:beginIndex        \"0\"^^xsd:nonNegativeInteger ;\n"
			+"        nif:endIndex          \"47\"^^xsd:nonNegativeInteger ;\n"
			+"        nif:isString          \"Tele 5 zeigt am 17.12. um 20.15 Uhr die Komödie\"^^xsd:string .\n"
			+"\n"
